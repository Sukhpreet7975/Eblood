            ...
            <div class="card-panel dark:card-panel-dark hover:shadow-xl transition">
                <div class="flex flex-col items-center text-center">
                    ...
                    <div class="mt-6 flex gap-3">
                        ...
                        <form method="POST" action="{{ route('toggle.availability') }}" id="profile-availability-form">
                            @csrf
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    if(toggleBtn){
        toggleBtn.addEventListener('click', async function(){
            ...
            try{
                const res = await fetch('{{ route('toggle.availability') }}', { method: 'POST', headers: { 'X-CSRF-TOKEN': csrf, 'Accept': 'application/json' } });
