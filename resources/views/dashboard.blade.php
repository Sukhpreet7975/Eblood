            ...
            <div class="hero-panel rounded-[2rem] px-5 py-7 sm:px-8 sm:py-8">
                <div class="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <span id="availability-badge" class="rounded-full px-4 py-2 text-sm font-bold backdrop-blur-sm {{ $user->isDonor() && $user->available == 'yes' ? 'bg-emerald-100 text-emerald-900' : 'bg-rose-100 text-rose-900' }}">
