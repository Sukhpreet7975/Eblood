            ...
            <div class="space-y-8">
                ...
                <div class="grid gap-4 sm:grid-cols-3">
                    <div class="rounded-3xl border border-white/10 bg-white/10 p-6 shadow-2xl shadow-black/10 backdrop-blur-xl">
                        ...
                        <p class="mt-4 text-3xl font-bold text-white">{{ $totalDonors }}</p>
                    ...
                    <div class="rounded-3xl border border-white/10 bg-white/10 p-6 shadow-2xl shadow-black/10 backdrop-blur-xl">
                        ...
                        <p class="mt-4 text-3xl font-bold text-white">{{ $availableDonors }}</p>
                    ...
                    <div class="rounded-3xl border border-white/10 bg-white/10 p-6 shadow-2xl shadow-black/10 backdrop-blur-xl">
                        ...
                        <p class="mt-4 text-3xl font-bold text-white">{{ $citiesCovered }}</p>
