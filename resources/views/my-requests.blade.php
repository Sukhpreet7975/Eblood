...
<div class="container mx-auto p-6">
    ...
    @if($requests->count() == 0)
        <div class="card-panel dark:card-panel-dark text-center">
            ...
            <a href="{{ route('requester.requests.create') }}" class="mt-4 inline-block bg-red-600 text-white px-6 py-2 rounded-lg">Create Request</a>
        </div>
    @else
                ...
                <div class="card-panel dark:card-panel-dark flex flex-col md:flex-row justify-between gap-4">
                    ...
                    <div class="flex flex-col items-start md:items-end gap-2">
                        ...
                        <div class="flex gap-2 mt-2">
                            <a href="{{ route('requester.requests.show', $request->_id) }}" class="text-sm text-red-600 hover:underline">View</a>
