    ...
    <div class="grid gap-6 xl:grid-cols-2">
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <div class="mt-5 grid gap-3 sm:grid-cols-2">
                ...
                <a href="{{ route('admin.analytics') }}" class="rounded-[1.5rem] border border-slate-200 p-4 transition hover:border-red-300 hover:bg-red-50 dark:border-slate-700 dark:hover:border-red-500 dark:hover:bg-slate-800">
                ...
                <a href="{{ route('admin.users.index') }}" class="rounded-[1.5rem] border border-slate-200 p-4 transition hover:border-red-300 hover:bg-red-50 dark:border-slate-700 dark:hover:border-red-500 dark:hover:bg-slate-800">
                    ...
                    <div class="rounded-[1.25rem] border border-slate-200 px-4 py-3 dark:border-slate-700">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-300">{{ optional($request->user)->email ?? 'Requesting user unavailable' }}</p>
                            </div>
