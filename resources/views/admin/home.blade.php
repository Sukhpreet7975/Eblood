...
<div class="space-y-8">
    <div class="rounded-[2rem] border border-slate-200 bg-gradient-to-br from-white via-red-50 to-rose-100 p-6 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:via-slate-900 dark:to-rose-950/60">
        <div class="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
            <div class="max-w-2xl">
                ...
                <h1 class="mt-4 text-3xl font-bold text-slate-900 dark:text-white sm:text-4xl">Welcome back, {{ $admin->name }}.</h1>
            ...
            <div class="rounded-[1.5rem] border border-white/80 bg-white/85 px-5 py-4 shadow-sm backdrop-blur dark:border-slate-700 dark:bg-slate-950/80">
                ...
                <p class="mt-3 text-lg font-semibold text-slate-900 dark:text-white">{{ $admin->email }}</p>
    ...
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <p class="mt-3 text-3xl font-bold text-slate-900 dark:text-white">{{ number_format($totalDonors) }}</p>
        ...
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <p class="mt-3 text-3xl font-bold text-emerald-600">{{ number_format($availableDonors) }}</p>
        ...
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <p class="mt-3 text-3xl font-bold text-amber-500">{{ number_format($totalRequests) }}</p>
        ...
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <p class="mt-3 text-3xl font-bold text-rose-600">{{ number_format($pendingRequests) }}</p>
    ...
    <div class="grid gap-6 xl:grid-cols-2">
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <div class="mt-5 grid gap-3 sm:grid-cols-2">
                <a href="{{ route('admin.dashboard') }}" class="rounded-[1.5rem] border border-slate-200 p-4 transition hover:border-red-300 hover:bg-red-50 dark:border-slate-700 dark:hover:border-red-500 dark:hover:bg-slate-800">
                ...
                <a href="{{ route('admin.requests.index') }}" class="rounded-[1.5rem] border border-slate-200 p-4 transition hover:border-red-300 hover:bg-red-50 dark:border-slate-700 dark:hover:border-red-500 dark:hover:bg-slate-800">
                ...
                <a href="{{ route('admin.donors.index') }}" class="rounded-[1.5rem] border border-slate-200 p-4 transition hover:border-red-300 hover:bg-red-50 dark:border-slate-700 dark:hover:border-red-500 dark:hover:bg-slate-800">
                ...
                <a href="{{ route('admin.requesters.index') }}" class="rounded-[1.5rem] border border-slate-200 p-4 transition hover:border-red-300 hover:bg-red-50 dark:border-slate-700 dark:hover:border-red-500 dark:hover:bg-slate-800">
        ...
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <div class="mt-5 space-y-3">
                <a href="{{ route('admin.home') }}" class="flex items-center justify-between rounded-[1.25rem] border border-slate-200 px-4 py-3 transition hover:border-red-200 hover:bg-red-50 dark:border-slate-700 dark:hover:border-red-500 dark:hover:bg-slate-800">
                    <span class="text-sm font-semibold text-slate-900 dark:text-white">Admin home</span>
                    <span class="text-red-600">→</span>
                </a>
                <a href="{{ route('admin.dashboard') }}" class="flex items-center justify-between rounded-[1.25rem] border border-slate-200 px-4 py-3 transition hover:border-red-200 hover:bg-red-50 dark:border-slate-700 dark:hover:border-red-500 dark:hover:bg-slate-800">
                    <span class="text-sm font-semibold text-slate-900 dark:text-white">Analytics dashboard</span>
                    <span class="text-red-600">→</span>
                </a>
                <a href="{{ route('admin.requests.index') }}" class="flex items-center justify-between rounded-[1.25rem] border border-slate-200 px-4 py-3 transition hover:border-red-200 hover:bg-red-50 dark:border-slate-700 dark:hover:border-red-500 dark:hover:bg-slate-800">
                    <span class="text-sm font-semibold text-slate-900 dark:text-white">Emergency requests</span>
                    <span class="text-red-600">→</span>
                </a>
                <a href="{{ route('admin.donors.index') }}" class="flex items-center justify-between rounded-[1.25rem] border border-slate-200 px-4 py-3 transition hover:border-red-200 hover:bg-red-50 dark:border-slate-700 dark:hover:border-red-500 dark:hover:bg-slate-800">
    ...
    <div class="grid gap-6 xl:grid-cols-2">
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            <div class="flex flex-wrap items-center justify-between gap-4">
                ...
                <a href="{{ route('admin.donors.index') }}" class="text-sm font-semibold text-red-600">View all donors</a>
            </div>
            <div class="mt-5 space-y-3">
                    ...
                    <div class="rounded-[1.25rem] border border-slate-200 px-4 py-3 dark:border-slate-700">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-300">{{ $donor->email }}</p>
                            </div>
                            <span class="inline-flex rounded-full bg-emerald-100 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-emerald-700 dark:bg-emerald-950/70 dark:text-emerald-200">{{ $donor->blood_group ?? 'Unknown' }}</span>
                        </div>
                        <div class="mt-2 flex flex-wrap items-center gap-2 text-sm text-slate-500 dark:text-slate-300">
                            ...
                            <span>{{ optional($donor->created_at)->diffForHumans() ?? 'just now' }}</span>
                        </div>
                    </div>
                @empty
        ...
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            <div class="flex flex-wrap items-center justify-between gap-4">
                ...
                <a href="{{ route('admin.requests.index') }}" class="text-sm font-semibold text-red-600">Review requests</a>
            </div>
            <div class="mt-5 space-y-3">
                    ...
                    <div class="rounded-[1.25rem] border border-slate-200 px-4 py-3 dark:border-slate-700">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-300">{{ optional($request->user)->email ?? 'Requester unavailable' }}</p>
                            </div>
                            <span class="inline-flex rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-slate-700 dark:bg-slate-800 dark:text-slate-100">{{ $request->status ?? 'Pending' }}</span>
                        </div>
                        <div class="mt-2 flex flex-wrap items-center gap-2 text-sm text-slate-500 dark:text-slate-300">
                            <span>{{ $request->blood_group ?? 'Unknown' }}</span>
                            <span aria-hidden="true">•</span>
                            <span>{{ $request->city ?? 'Unknown city' }}</span>
                            <span aria-hidden="true">•</span>
                            <span>{{ optional($request->updated_at)->diffForHumans() ?? 'just now' }}</span>
                        </div>
                    </div>
                @empty
