            ...
            <div class="mt-4 card-panel dark:card-panel-dark">
                ...
                <form method="GET" action="{{ route('admin.requests.index') }}" class="mt-5 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="requester_email" value="{{ request('requester_email') ?? request('donor_email') }}" placeholder="user@example.com" class="form-field dark:form-field-dark mt-2" />
                    </div>
                                    ...
                                    <div class="flex-1">
                                        <div class="flex flex-wrap items-start gap-3">
                                            <div>
                                                ...
                                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Requesting user: {{ optional($request->user)->email ?? 'Unknown' }}</p>
                                            </div>
