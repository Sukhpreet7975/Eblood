            ...
            <div class="mt-6 rounded-3xl border border-slate-200 bg-slate-50 p-5 dark:border-slate-700 dark:bg-slate-900/70">
                <div class="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <form id="availability-form" method="POST" action="{{ route('toggle.availability') }}">
                        @csrf
                        <button id="toggle-availability-btn" type="button" class="rounded-full px-5 py-3 text-sm font-semibold {{ $user->available == 'yes' ? 'bg-red-600 text-white hover:bg-red-700' : 'bg-emerald-600 text-white hover:bg-emerald-700' }}">
