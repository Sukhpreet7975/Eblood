...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="grid gap-3 sm:grid-cols-2">
                                <div>
                                    <input id="role-user" type="radio" name="role" value="user" <?php echo e(old('role', 'user') === 'user' ? 'checked' : ''); ?> class="peer sr-only" required>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MyProject\eblood\resources\views/auth/login.blade.php ENDPATH**/ ?>