...
<div class="space-y-8">
    ...
    <div id="requester-priority-data" class="hidden">
        <?php echo json_encode($recentRequests->map(function ($request) {
            return [
                'blood_group' => $request->blood_group, 'status' => $request->status ?? 'Pending', 'created_at' => optional($request->created_at)->toISOString()) ?>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MyProject\eblood\resources\views\requester\home.blade.php ENDPATH**/ ?>