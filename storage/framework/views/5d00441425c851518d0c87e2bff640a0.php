            ...
            <div class="hidden md:flex items-center gap-3 text-sm">
                ...
                <?php else: ?>
                    <?php if(auth()->user()->isAdmin()): ?>
                        ...
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="<?php echo e($adminLinkClasses); ?> <?php echo e(request()->routeIs('admin.users.*') ? $adminActiveClasses : $adminInactiveClasses); ?>">Manage Users</a>
                        <a href="<?php echo e(route('admin.analytics')); ?>" class="<?php echo e($adminLinkClasses); ?> <?php echo e(request()->routeIs('admin.analytics') ? $adminActiveClasses : $adminInactiveClasses); ?>">Donor Analytics</a>
                        ...
                        <a href="<?php echo e(route('admin.notifications')); ?>" class="<?php echo e($adminLinkClasses); ?> <?php echo e(request()->routeIs('admin.notifications') ? $adminActiveClasses : $adminInactiveClasses); ?>">Notifications</a>
                    <?php elseif(auth()->user()->isDonor()): ?>
                        ...
                        <a href="<?php echo e(route('availability')); ?>" class="rounded-full px-4 py-2 text-slate-700 hover:bg-red-50 hover:text-red-600 dark:text-slate-200 dark:hover:bg-slate-800">Availability</a>
                    <?php else: ?>
        ...
        <div id="mobile-menu" class="hidden flex-col gap-3 px-4 pb-4 md:hidden">
            ...
            <?php else: ?>
                <?php if(auth()->user()->isAdmin()): ?>
                    ...
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="<?php echo e($mobileAdminLinkClasses); ?> <?php echo e(request()->routeIs('admin.users.*') ? $mobileAdminActiveClasses : $mobileAdminInactiveClasses); ?>">Manage Users</a>
                    <a href="<?php echo e(route('admin.analytics')); ?>" class="<?php echo e($mobileAdminLinkClasses); ?> <?php echo e(request()->routeIs('admin.analytics') ? $mobileAdminActiveClasses : $mobileAdminInactiveClasses); ?>">Donor Analytics</a>
                    ...
                    <a href="<?php echo e(route('admin.notifications')); ?>" class="<?php echo e($mobileAdminLinkClasses); ?> <?php echo e(request()->routeIs('admin.notifications') ? $mobileAdminActiveClasses : $mobileAdminInactiveClasses); ?>">Notifications</a>
                <?php elseif(auth()->user()->isDonor()): ?>
                    ...
                    <a href="<?php echo e(route('availability')); ?>" class="block rounded-2xl px-4 py-3 text-slate-900 hover:bg-red-100 hover:text-red-700 dark:text-slate-100 dark:hover:bg-slate-800">Availability</a>
                <?php else: ?>
