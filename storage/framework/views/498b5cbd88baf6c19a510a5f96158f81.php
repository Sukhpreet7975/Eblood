...
<div class="space-y-6">
    ...
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <p class="mt-3 text-3xl font-bold text-slate-900 dark:text-white"><?php echo e($totalUsers ?? 0); ?></p>
        ...
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <p class="mt-3 text-3xl font-bold text-red-600"><?php echo e($totalDonors ?? 0); ?></p>
        ...
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <p class="mt-3 text-3xl font-bold text-emerald-600"><?php echo e($availableDonors ?? 0); ?></p>
        ...
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <p class="mt-3 text-3xl font-bold text-amber-500"><?php echo e($bloodRequests ?? 0); ?></p>
        ...
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <p class="mt-3 text-3xl font-bold text-rose-600"><?php echo e($pendingRequests ?? 0); ?></p>
    ...
    const renderAnalyticsCharts = () => {
        ...
        if (requestHotspotsCtx) {
            requestHotspotsChart = new Chart(requestHotspotsCtx, {
                type: 'pie',
                data: {
                    labels: <?php echo json_encode($requestsByCityLabels ?? [], 15, 512) ?>,
                    datasets: [{
                        data: <?php echo json_encode($requestsByCityData ?? [], 15, 512) ?>,
                        backgroundColor: analyticsColors
                    }]
                },
                options: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MyProject\eblood\resources\views/admin/analytics.blade.php ENDPATH**/ ?>