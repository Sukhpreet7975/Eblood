            ...
            <div id="mobile-menu" class="hidden flex-col gap-3 px-4 pb-4 md:hidden">
                ...
                <?php else: ?>
                    <?php if(auth()->user()->isAdmin()): ?>
                        ...
                        <a href="<?php echo e(route('admin.analytics')); ?>" class="<?php echo e($mobileAdminLinkClasses); ?> <?php echo e(request()->routeIs('admin.analytics') ? $mobileAdminActiveClasses : $mobileAdminInactiveClasses); ?>">Analytics</a>
