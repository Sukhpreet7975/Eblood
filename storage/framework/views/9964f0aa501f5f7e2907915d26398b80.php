...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-start justify-between gap-4 mb-6">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('admin.requests.index')); ?>" class="inline-flex items-center gap-2 rounded-full bg-slate-100 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-200">Back to Requests</a>
            ...
            <div class="card-panel dark:card-panel-dark p-6">
                ...
                <div class="mt-4 grid gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <p class="mt-1 font-semibold text-slate-900 dark:text-slate-100"><?php echo e($request->patient_name); ?></p>
                    </div>
                    <div>
                        <h3 class="text-xs font-medium text-slate-600 dark:text-slate-400">Blood Group</h3>
                        <p class="mt-1 font-semibold text-slate-900 dark:text-slate-100"><?php echo e($request->blood_group); ?></p>
                    </div>
                    <div>
                        <h3 class="text-xs font-medium text-slate-600 dark:text-slate-400">Hospital</h3>
                        <p class="mt-1 text-slate-700 dark:text-slate-300"><?php echo e($request->hospital); ?></p>
                    </div>
                    <div>
                        <h3 class="text-xs font-medium text-slate-600 dark:text-slate-400">City</h3>
                        <p class="mt-1 text-slate-700 dark:text-slate-300"><?php echo e($request->city); ?></p>
                    </div>
                    <div>
                        <h3 class="text-xs font-medium text-slate-600 dark:text-slate-400">Phone</h3>
                        <p class="mt-1 text-slate-700 dark:text-slate-300"><?php echo e($request->phone); ?></p>
                    </div>
                    <div>
                        <h3 class="text-xs font-medium text-slate-600 dark:text-slate-400">Requested</h3>
                        <p class="mt-1 text-slate-700 dark:text-slate-300"><?php echo e(optional($request->created_at)->format('Y-m-d H:i')); ?></p>
                    </div>
                </div>

                <div class="mt-6">
                    <h3 class="text-sm font-medium text-slate-700 dark:text-slate-300">Message</h3>
                    <div class="mt-2 card-panel dark:card-panel-dark p-4 text-slate-700 dark:text-slate-200 whitespace-pre-line"><?php echo e($request->message ?? 'No message provided.'); ?></div>
                </div>
                ...
                <?php if($request->admin_message): ?>
                    <div class="mt-6 card-panel dark:card-panel-dark p-4">
                        ...
                        <p class="mt-2 text-slate-700 dark:text-slate-200 whitespace-pre-line"><?php echo e($request->admin_message); ?></p>
                ...
                <?php if(!empty($request->attachments)): ?>
                    <div class="mt-6">
                        ...
                        <div class="mt-2 grid gap-3 sm:grid-cols-2">
                            <?php $__currentLoopData = $request->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e($file); ?>" target="_blank" class="inline-flex items-center gap-2 rounded-md border border-slate-200 px-3 py-2 text-sm text-slate-700 hover:bg-slate-50">Download</a>
        ...
        <aside>
            <div class="card-panel dark:card-panel-dark p-6 space-y-4">
                <div>
                    ...
                    <p class="mt-1 font-semibold text-slate-900 dark:text-slate-100"><?php echo e(optional($request->user)->name ?? 'Unknown'); ?></p>
                    <p class="text-xs text-slate-500 dark:text-slate-400"><?php echo e(optional($request->user)->email ?? '-'); ?></p>
                </div>
                ...
                <div>
                    ...
                    ?>
                    <div class="mt-2">
                        <span class="inline-flex rounded-full px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] <?php echo e($statusClass); ?>"><?php echo e($request->status); ?></span>
                    </div>
                </div>
                ...
                <div class="mt-2">
                    ...
                    <div class="mt-3 space-y-2">
                        <form method="POST" action="/admin/requests/<?php echo e($request->_id); ?>/status">
                            <?php echo csrf_field(); ?>
                        ...
                        <form method="GET" action="/admin/delete-user/<?php echo e(optional($request->user)->_id ?? ''); ?>" onsubmit="return confirm('Delete user?')">
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                openButtons.forEach(button => {
                    button.addEventListener('click', () => {
                        ...
                        form.action = '/admin/requests/<?php echo e($request->_id); ?>/status';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MyProject\eblood\resources\views/admin/request-detail.blade.php ENDPATH**/ ?>