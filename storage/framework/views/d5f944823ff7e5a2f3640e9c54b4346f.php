...
<div class="grid md:grid-cols-4 gap-6 mb-10">
    ...
    <div class="card-panel dark:card-panel-dark">
        ...
        <p class="text-3xl font-bold text-yellow-500"><?php echo e($pendingRequests ?? 0); ?></p>
    </div>

    <div class="card-panel dark:card-panel-dark">
        <h3 class="text-sm text-slate-500 dark:text-slate-400">Approved</h3>
        <p class="text-3xl font-bold text-blue-500"><?php echo e($approvedRequests ?? 0); ?></p>
    </div>

    <div class="card-panel dark:card-panel-dark">
        <h3 class="text-sm text-slate-500 dark:text-slate-400">Completed</h3>
        <p class="text-3xl font-bold text-green-500"><?php echo e($completedRequests ?? 0); ?></p>
    </div>

    <div class="card-panel dark:card-panel-dark">
        <h3 class="text-sm text-slate-500 dark:text-slate-400">Rejected</h3>
        <p class="text-3xl font-bold text-red-500"><?php echo e($rejectedRequests ?? 0); ?></p>
    </div>
...
<div class="grid gap-6 xl:grid-cols-3 mb-10">
    ...
    <div class="card-panel dark:card-panel-dark hover:shadow-slate-200/20 transition duration-300">
        ...
        <p class="text-4xl font-extrabold text-red-600"><?php echo e($totalDonors); ?></p>
    ...
    <div class="card-panel dark:card-panel-dark hover:shadow-slate-200/20 transition duration-300">
        ...
        <p class="text-4xl font-extrabold text-green-600"><?php echo e($availableDonors); ?></p>
...
<div class="card-panel dark:card-panel-dark mb-10">
    ...
    <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        <?php $__currentLoopData = $recentDonors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $donor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card-panel dark:card-panel-dark">
                <p class="font-semibold text-slate-900 dark:text-slate-100"><?php echo e($donor->name); ?></p>
                <p class="text-sm text-slate-500 dark:text-slate-400"><?php echo e($donor->email); ?></p>
                <p class="mt-3 text-sm text-slate-500 dark:text-slate-400"><?php echo e($donor->blood_group ?? 'Unknown'); ?> • <?php echo e($donor->city ?? 'No city'); ?></p>
            </div>
    ...
    */
    ...
    const createCityChart = () => {
        ...
        return new Chart(cityCtx, {
            type: 'pie',
                data: {
                labels: <?php echo json_encode($cityLabels ?? [], 15, 512) ?>,
                datasets: [{
                    data: <?php echo json_encode($cityData ?? [], 15, 512) ?>,
                    backgroundColor: [
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\MyProject\eblood\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>