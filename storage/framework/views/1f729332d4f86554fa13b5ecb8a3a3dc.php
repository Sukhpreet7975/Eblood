...
<div class="space-y-8">
    ...
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <p class="mt-3 text-3xl font-bold text-sky-600"><?php echo e($totalUsers ?? 0); ?></p>
        ...
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <p class="mt-2 text-sm text-slate-500 dark:text-slate-300">Average <?php echo e($requestsPerUser); ?> per user</p>
        </div>
    </div>
